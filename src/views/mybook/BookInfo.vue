...
<template>
    <div class="app-container">
        ...
        <div class="p10bg255 mt20">
            <div class="normalT1 mb20">其他信息</div>
            <el-row type="flex" justify="center">
                <el-col :xs="24" :sm="16" :md="12" :lg="10" :xl="8">
                    <el-form ref="form" :model="form" label-width="120px">
                        <el-row>
                            <el-form-item label="预约人：" prop="materialGroupId">
                                {{form.creatorName}}
                            </el-form-item>
                            <el-form-item label="预约时间：">
                                {{form.createTime}}
                            </el-form-item>
                            <el-form-item label="预约状态：" prop="materialGroupId">
                                {{form.statusShift}}
                            </el-form-item>
                            <el-form-item label="审核人：" prop="materialGroupId">
                                {{form.checkerName}}
                            </el-form-item>
