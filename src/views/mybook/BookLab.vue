                    ...
                    <el-form ref="form" :model="form" :rules="rules" label-width="130px">
                        <el-row>
                            <el-form-item label="预约实验室：" prop="labId">
                                <el-select v-model="form.labId" placeholder="请选择"
                                    @change="labChange">
                            ...
                            <el-form-item label="已选择：">
                                <div v-for="(ii,ix) in newArr" :key="ix">
                                    {{ii.name}}
                                </div>
                            </el-form-item>
                            ...
                            <el-form-item label="使用目的：" prop="purpose">
                                <el-select v-model="form.purpose" placeholder="请选择" clearable="">
                                    <el-option v-for="dict in purposes" :key="dict" :label="dict"
                                        :value="dict"></el-option>
                                </el-select>
                                <el-input v-model="form.description" placeholder="若是其它目的，请填写备注说明"
                                    class="mt10" />
                            </el-form-item>
                            <el-form-item label="上课教师：" prop="teacherIds">
                                <el-select v-model="form.teacherIds" multiple placeholder="请选择">
                                    <el-option v-for="dict in teachers" :key="dict.id"
                                        :label="dict.nickName" :value="dict.id"></el-option>
                                </el-select>
                                <el-input v-model="form.teacherDescription"
                                    placeholder="若无上课教师，请填写备注说明" class="mt10" />
                            </el-form-item>
                            <el-form-item label="上课班级：" prop="classIds">
                                ...
                                <el-input v-model="form.classDescription"
                                    placeholder="若无上课班级，请填写备注说明" class="mt10" />
                            </el-form-item>
...
import { appointmentAdd, appointmentUpdate } from '@/api/yc_book.js';
export default {
    name: 'BookLab',
    data() {
        ...
        return {
            ...
            rules: {
                ...
                purpose: [
                    { required: true, validator: checkPurpose, trigger: 'change' }
                ],
                teacherIds: [
                    { required: true, validator: checkTeacher, trigger: 'change' }
                ],
                classIds: [
            ...
            labs: [],
            lessons: [],
            purposes: ['实训', '实验', '实习', '开会', '答辩', '大赛', '学科竞赛', '创新创业', '教学辅导',],
            teachers: [],
            classes: [],
            newArr: []
        };
