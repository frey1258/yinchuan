<template>
    <div class="app-container">
        ...
        <div class="p10bg255 mt20">
            ...
            <el-table :data="list" v-loading="listLoading" ref="menuTable">
                ...
                <el-table-column label="是否显示" width="100" align="center">
                    <template slot-scope="scope">
                        <el-switch @change="handleHiddenChange(scope.$index, scope.row)"
                            :active-value="0" :inactive-value="1" v-model="scope.row.hidden">
                        </el-switch>
                    </template>
                </el-table-column>
            ...
            <div class="pagination-container">
                <el-pagination background @size-change="handleSizeChange"
                    ...
                    :page-sizes="[10,15,20]" :current-page.sync="listQuery.pageNum" :total="total">
                </el-pagination>
            </div>
        </div>
    </div>
...
<script>
import { fetchList, deleteMenu, updateMenu, updateHidden } from '@/api/ums_menu'
