    ...
    <div class="app-container">
        ...
        <el-form :model="listQuery" size="small" :inline="true" label-width="100px" class="p10bg255"
            ...
            <el-form-item label="资源名称：">
                <el-input v-model="listQuery.nameKeyword" class="input-width" placeholder="资源名称"
                    clearable></el-input>
            </el-form-item>
            <el-form-item label="资源路径：">
                <el-input v-model="listQuery.urlKeyword" class="input-width" placeholder="资源路径"
                    clearable></el-input>
            </el-form-item>
            <el-form-item label="资源分类：">
                <el-select v-model="listQuery.categoryId" placeholder="全部" clearable
                    class="input-width">
        ...
        <div class="p10bg255 mt20">
            <el-row :gutter="10" style="margin:0px;">
                <el-col :span="1.5">
                    ...
                    <el-button size="mini" icon="el-icon-coin" type="primary"
                        @click="handleShowCategory()">资源分类</el-button>
                </el-col>
            </el-row>

            <el-table :data="list" ref="resourceTable" v-loading="listLoading">
...
<script>
import { fetchList, createResource, updateResource, deleteResource } from '@/api/ums_resource';
import { listAllCate } from '@/api/ums_resourceCategory';
