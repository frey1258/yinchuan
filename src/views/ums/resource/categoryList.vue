<template> 
    <div class="app-container">
        ...
        <div class="p10bg255 mt20">
            ...
            <el-table :data="list" ref="resourceCategoryTable" v-loading="listLoading">
        ...
        <el-dialog title="添加分类" :visible.sync="dialogVisible" width="40%">
            <el-form :model="resourceCategory" ref="resourceCategoryForm" label-width="150px"
                size="small">
...
<script>
import { listAllCate, createResourceCategory, updateResourceCategory, deleteResourceCategory } from '@/api/ums_resourceCategory';
